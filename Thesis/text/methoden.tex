...
\caption{Functional Requirements}
	\begin{tabular}{| m{0.08\textwidth} | m{0.13\textwidth}| m{0.07\textwidth} | m{0.62\textwidth}|} 
  	\hline
...
\begin{table}[ht]
	...
	\label{tab:nonfn_req}
	\begin{tabular}{ | m{0.13\textwidth} | m{0.13\textwidth}| m{0.08\textwidth} | m{0.56\textwidth} |} 
  	\hline
