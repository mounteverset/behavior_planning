...
A simplified behavior tree only depicting the top level behavior control nodes is shown in figure \ref{fig:top_level_bt}. The tree receives the inital tick signal from the root in an infinite loop. 
\begin{figure}[ht]
