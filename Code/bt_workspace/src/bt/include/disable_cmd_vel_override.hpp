...
class DisableCmdVelOverride : public BT::SyncActionNode
{   
    public:

    DisableCmdVelOverride(const std::string& name) : BT::SyncActionNode(name, {})
    {
        node_= rclcpp::Node::make_shared("disable_cmd_vel_override");
